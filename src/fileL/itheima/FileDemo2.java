...
public class FileDemo2 {
    public static void main(String[] args) throws IOException {
        ...
        //boolean mkdir()：当指定文件不存在时创建文件并返回true，否则返回false
        //File f3=new File("b");
        //System.out.println(f3.mkdir());

        //boolean mkdirs():创建指定文件夹，当文件夹所在目录不存在，则顺带一块创建了
        ...
        //boolean delete() :当指定的文件或文件夹存在时删除指定的文件或者文件夹并返回true，否则返回false
